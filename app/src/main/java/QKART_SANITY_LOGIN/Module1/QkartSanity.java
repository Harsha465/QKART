...
public class QkartSanity {
    ...
    public static Boolean TestCase04(RemoteWebDriver driver) throws InterruptedException {
        ...
        List searchResults = homePage.getSearchResults();
        ...
        Iterator var7 = searchResults.iterator();
        if (var7.hasNext()) {
           WebElement webElement = (WebElement)var7.next(); //typecasting which results are in a list to Webelemnt
