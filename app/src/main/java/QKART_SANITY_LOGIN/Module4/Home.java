...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            Thread.sleep(3000);
            List<WebElement> ele = driver.findElements(By.xpath("//h4[text()=' No products found ']"));
            List<WebElement> products = driver.findElements(By.className("css-yg30e6"));
            if(ele.isEmpty() || products.size() > 0){
                return true;
            }else{
                return false;
            }
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            // //div[@class='cart MuiBox-root css-0']//div[contains(@class,'css-zgtx0t')]
            WebElement cartParent = driver.findElement(By.xpath("//div[contains(@class,'cart MuiBox')]"));
